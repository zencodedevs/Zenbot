...
namespace ZenAchitecture.WebUI.Filters
{
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public ApiExceptionFilterAttribute()
        {
            ...
            {
                { typeof(ZenException), HandleZenException },
                { typeof(ZenValidationException), HandleZenValidationException },
        ...
        private void HandleZenValidationException(ExceptionContext context)
        {
            var exception = context.Exception as ZenValidationException;
        ...
        private void HandleZenException(ExceptionContext context)
        {
            int statusCode = 1001;
