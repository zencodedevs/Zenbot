...
export interface IZenbotClient {
...
export class ZenbotClient implements IZenbotClient {
    ...
    jira(): Observable<void> {
        let url_ = this.baseUrl + "/api/v1/Zenbot/jira";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processJira(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processJira(<any>response_);
                } catch (e) {
    ...
    protected processJira(response: HttpResponseBase): Observable<void> {
